...
var ASM_CONSTS = {
  93576: () => { if (document.fullscreenElement) return 1; },  
 93622: () => { return document.getElementById('canvas').width; },  
 93674: () => { return parseInt(document.getElementById('canvas').style.width); },  
 93742: () => { document.exitFullscreen(); },  
 93769: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 93842: () => { if (document.fullscreenElement) return 1; },  
 93888: () => { return document.getElementById('canvas').width; },  
 93940: () => { return screen.width; },  
 93965: () => { document.exitFullscreen(); },  
 93992: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 94125: () => { return window.innerWidth; },  
 94151: () => { return window.innerHeight; },  
 94178: () => { if (document.fullscreenElement) return 1; },  
 94224: () => { return document.getElementById('canvas').width; },  
 94276: () => { return parseInt(document.getElementById('canvas').style.width); },  
 94344: () => { if (document.fullscreenElement) return 1; },  
 94390: () => { return document.getElementById('canvas').width; },  
 94442: () => { return screen.width; },  
 94467: () => { return window.innerWidth; },  
 94493: () => { return window.innerHeight; },  
 94520: () => { if (document.fullscreenElement) return 1; },  
 94566: () => { return document.getElementById('canvas').width; },  
 94618: () => { return screen.width; },  
 94643: () => { document.exitFullscreen(); },  
 94670: () => { if (document.fullscreenElement) return 1; },  
 94716: () => { return document.getElementById('canvas').width; },  
 94768: () => { return parseInt(document.getElementById('canvas').style.width); },  
 94836: () => { document.exitFullscreen(); },  
 94863: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 94921: () => { return screen.width; },  
 94946: () => { return screen.height; },  
 94972: () => { return window.screenX; },  
 94999: () => { return window.screenY; },  
 95026: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 95079: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 95150: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 95207: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 95463: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 95534: () => { if (document.fullscreenElement) return 1; },  
 95580: () => { return window.innerWidth; },  
 95606: () => { return window.innerHeight; },  
 95633: () => { if (document.pointerLockElement) return 1; }
};
